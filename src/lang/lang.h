...
enum LangText {
    ...
    LANG_TEXT_INITIALISE_ERROR,
    LANG_TEXT_SWITCHING_DISPLAY_STATE,
    LANG_TEXT_MINING_STATUS,
    LANG_TEXT_MAX
};
...
#define LANG_TEXT_INITIALISE_ERROR (CurrentLang->text[LANG_TEXT_INITIALISE_ERROR])
#define LANG_TEXT_SWITCHING_DISPLAY_STATE (CurrentLang->text[LANG_TEXT_SWITCHING_DISPLAY_STATE])
#define LANG_TEXT_MINING_STATUS (CurrentLang->text[LANG_TEXT_MINING_STATUS])
